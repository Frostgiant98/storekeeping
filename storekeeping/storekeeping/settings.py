"""
Django settings for storekeeping project.
...
SECRET_KEY = 'django-insecure-$mv*jx)vj2njsyok#pb9p%d7htrvq^428x^56mxpsz$2&c5+(e'
...
MIDDLEWARE = [
    ...
    'storekeeping.middleware.metric_middleware',
